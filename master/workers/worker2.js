...
module.exports = {
    ...
    execute: async (job, updateStageStatus, sleep) => {
        ...
        console.log(`🐍 [Worker 2] Starting job #${job.id} (Active jobs: ${activeJobs}/${MAX_CAPACITY})`);
        ...
        try {
            ...
            if (isSuccess) {
                ...
                console.log(`✅ [Worker 2] SUCCESS job #${job.id}`);
            } else {
                ...
                if (job.retry_count < MAX_RETRIES) {
                    ...
                    console.log(`🔄 [Worker 2] Failed job #${job.id}. Returning to queue...`);
                } else {
            ...
            console.error(`🐍 [Worker 2] Error:`, err);
        } finally {
